...
--Query #3 List the manager of each department along with their department number, department name, employee number, 
...
--Query #4 List the department number for each employee along with that employee’s employee number, last name, 
...
--Query #5 List first name, last name, and sex of each employee whose first name is Hercules 
...
--Query #7 List each employee in the Sales and Development departments, including their employee number, last name,
--			first name, and department name
SELECT e.first_name, e.last_name, e.emp_no, d.dept_name
FROM employees as e
JOIN dept_emp as de
